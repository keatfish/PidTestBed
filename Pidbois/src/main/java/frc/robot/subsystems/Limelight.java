 ...
 *
 */
public class Limelight extends Subsystem implements RobotMap{
...
//  Reading and Writing from the "limelight" Table in NetworkTables
	...
	NetworkTableEntry targetSkewEntry = limelightTable.getEntry("ts");
    ...
    public void initDefaultCommand() {setDefaultCommand(new GetLimelightData());}
